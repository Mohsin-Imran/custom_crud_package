...
<body>
    ...
    <h1 class="text-center mt-5" style="font-family: 'Times New Roman';">Mr Mohsin Crud Package</h1>
    @if(session('success'))
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('student.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <input type="text" class="form-control" placeholder="Number" name="number"><br>
